...
\begin{keypoints}
	\item Our constrained circulation ensemble can reproduce the 2020 SWUS drought.
	...
	\item Our 2020 constrained ensemble is comparable to droughts seen in a fully coupled large ensemble, and likewise for an 1850 analogue, but is drier than the fully coupled model in 2090.
\end{keypoints}
...
Nudging occurred four times per day in each grid cell outside the box bounded by 28$^{\circ}$N, 47$^{\circ}$N, 130$^{\circ}$W, 96$^{\circ}$W (Figure \ref{fig:fig1}a). This serves to constrain the large-scale circulation, imposing meteorological drought conditions for every ensemble member. Inside the bounding box, the atmosphere evolves freely, allowing for local land-atmosphere coupling, which is necessary for studying the effects of initial conditions.  

...
Another technique, reinitialized ensemble boosting, involves branching a fully coupled simulation ahead of a key event, and introducing roundoff level atmospheric perturbations to generate an ensemble of simulations. 
...
This technique is very effective at up-sampling the extreme event, but generally can only sample a small range of initial conditions. 
